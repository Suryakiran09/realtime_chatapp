...
### `I have made this application Deployment ready for both Heroku and Docker image deployment because those applications are asking for Credit Caed I couldnt deploy it.`
